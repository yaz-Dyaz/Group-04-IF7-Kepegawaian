                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <?php
                                        $no = 1;
                                        $list = mysqli_query($conn, "SELECT * FROM pegawai");
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <center><?php echo $row['id_pegawai'] ?>
                                                </td>
                                                <td>
                                                    <center><?php echo $row['tgl_daftar'] ?>
                                                </td>
                                                <td>
                                                    <center><?php echo $row['nm_pegawai'] ?>
                                                </td>
                                                <td>
                                                    <center><?php echo $row['jk'] ?>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <center><a
                                                            href="detail-pegawai.php?id=<?php echo $row['id_pegawai'] ?>"
                                                            class="btn btn-primary">Detail</a>
                                                </td>
                                                <td>
                                                    <center><a
                                                            href="update-pegawai.php?id=<?php echo $row['id_pegawai'] ?>"
                                                            class="btn btn-warning">Update</a>
                                                </td>
                                                <td>
                                                    <center><a
                                                            href="delete-pegawai.php?id=<?php echo $row['id_pegawai'] ?>"
