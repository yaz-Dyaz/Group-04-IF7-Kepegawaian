...
<head>
    ...
    <title>Dashboard | Log Update</title>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <?php
                                        $list = mysqli_query($conn, "SELECT * FROM log_perubahan");
                                        while($row = mysqli_fetch_assoc($list)) {
                                        ?>
                                            <tr>
                                                <td>
                                                    <center><?php echo $row['id_perubahan'] ?>
                                                </td>
                                                <td>
                                                    <center><?php echo $row['waktu'] ?>
                                                </td>
                                                <td>
                                                    <center><?php echo $row['nm_pegawai'] ?>
                                                </td>
                                                <td>
                                                    <center><?php echo $row['old_id_bagian'] ?>
                                                </td>
                                                <td>
                                                    <center><?php echo $row['new_id_bagian'] ?>
                                                </td>
                                                <td>
                                                    <center><a
                                                            href="delete-log.php?id=<?php echo $row['id_perubahan'] ?>"
