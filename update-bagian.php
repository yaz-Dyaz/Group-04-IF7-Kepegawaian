...
//   supaya gabisa langsung akses ke dashboard sebelum login
    ...
    $bagian = mysqli_query($conn, "SELECT * FROM bagian WHERE id_bagian = '".$_GET['id']."' ");
    $b =mysqli_fetch_object($bagian);
...
<head>
    ...
    <title>Dashboard | Update Bagian</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <div class="d-sm align-items-center justify-content-between mb-4">
                                <h4 class="m-0 font-weight-bold text-primary">Edit Data bagian</h4>
                                <div class="table-responsive">
                                </div>
                            </div>

                            <form action="save-update-bagian.php" method="post">
                    ...
                    <td>ID Bagian</td>
                    <td>:</td>
                    <td><input type="text" name="id_bagian" class="form-control" value="<?php echo $b->id_bagian ?>" readonly></td>
                </tr>
                    <tr>
                        <td>Nama Bagian</td>
                        <td>:</td>
                        <td><input type="text" name="nama_bagian" class="form-control" value="<?php echo $b->nama_bagian ?>" required></td>
                    </tr>
                    <tr>
                        <td>Gaji</td>
                        <td>:</td>
                        <td><input type="number" name="gaji" class="form-control" value="<?php echo $b->gaji ?>" required></td>
                    </tr>
                    <tr>
                        <td>Jumlah Yang Dibutuhkan</td>
                        <td>:</td>
                        <td><input type="number" name="jml_staf" class="form-control" value="<?php echo $b->jml_staf ?>" required></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td></td>
