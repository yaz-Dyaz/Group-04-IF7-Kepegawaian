                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <div class="d-sm align-items-center justify-content-between mb-4">
                                <h4 class="m-0 font-weight-bold text-primary">Data Bagian</h4>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <?php
                                        $no = 1;
                                        $list = mysqli_query($conn, "SELECT * FROM bagian");
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <center><?php echo $row['id_bagian'] ?>
                                                </td>
                                                <td>
                                                    <center><?php echo $row['nama_bagian'] ?>
                                                </td>
                                                <td>
                                                    <center><?php echo $row['gaji'] ?>
                                                </td>
                                                <td>
                                                    <center><?php echo $row['jml_staf'] ?>
                                                </td>
                                                <td>
                                                    <center><a
                                                            href="update-bagian.php?id=<?php echo $row['id_bagian'] ?>"
                                                            class="btn btn-warning">Update</a>
                                                </td>
                                                <td>
                                                    <center><a
                                                            href="delete-bagian.php?id=<?php echo $row['id_bagian'] ?>"
