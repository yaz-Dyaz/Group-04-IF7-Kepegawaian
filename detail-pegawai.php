...
//   supaya gabisa langsung akses ke dashboard sebelum login
    ...
    $pegawai = mysqli_query($conn, "SELECT pegawai.id_pegawai, pegawai.tgl_daftar, pegawai.nm_pegawai, pegawai.tmp_lahir, pegawai.tgl_lahir, pegawai.jk, pegawai.agama, pegawai.almt_pegawai, pegawai.telp, bagian.nama_bagian, bagian.gaji FROM pegawai, bagian WHERE pegawai.id_pegawai = '".$_GET['id']."' AND pegawai.id_bagian=bagian.id_bagian");
...
<head>
    ...
    <title>Dashboard | Detail Pegawai</title>
