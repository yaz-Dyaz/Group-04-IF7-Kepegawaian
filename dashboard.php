...
//   supaya gabisa langsung akses ke dashboard sebelum login
    ...
    $tmp = mysqli_fetch_object($tampil);
        ...
        $data_pegawai = mysqli_query($conn, "SELECT COUNT(*) as total FROM pegawai");
        $data_bagian = mysqli_query($conn, "SELECT COUNT(*) as total FROM bagian");
        $d_pegawai = mysqli_fetch_array($data_pegawai);
        $d_bagian = mysqli_fetch_array($data_bagian);
        ?>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <!-- Data jumlah Apoteker-->
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-Lfont-weight-bold text-primary text-uppercase mb-1">
                                                Pegawai</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php
														echo $d_pegawai['total'];
														?></div>
                                        </div>
                                        <div class="col-auto">
